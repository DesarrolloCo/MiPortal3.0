...
@section('main')
                ...
                <div class="row page-titles">
                    ...
                    <div class="col-md-6 col-4 align-self-center">
                        <button class="btn float-right hidden-sm-down btn-success" data-toggle="modal" data-bs-toggle="modal" data-target="#Add_Tipo" data-bs-target="#Add_Tipo"><i class="mdi mdi-plus-circle"></i> Agregar</button>
                                                        ...
                                                        <tbody>
                                                            @foreach ($tipo_mantenimientos as $tipo_mantenimiento)
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <button type="button" class="btn btn-primary" rel="tooltip" data-toggle="modal" data-bs-toggle="modal" data-target="#Edit_TIPO{{ $tipo_mantenimiento->TIP_ID }}" data-bs-target="#Edit_TIPO{{ $tipo_mantenimiento->TIP_ID }}">
...
$(document).ready(function() {
    console.log("Tipo modal script loaded");

    // Handler for add buttons (dynamic based on found patterns)
    
    $("[data-target=\"#Add_Tipo\"]").click(function(e) {
        e.preventDefault();
        console.log("Add button clicked for Add_Tipo");
        $("#Add_Tipo").show().addClass("show");
    ...
    $("[data-target^=\"#Edit_TIPO\"]").click(function(e) {
        e.preventDefault();
