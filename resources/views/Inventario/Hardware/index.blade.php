...
@section('main')
                ...
                <div class="row page-titles">
                    <div class="col-md-6 col-8 align-self-center">
                        <h3 class="text-themecolor mb-0 mt-0">Hardware</h3>
                        <ol class="breadcrumb">
                    ...
                    <div class="col-md-6 col-4 align-self-center">
                        <button class="btn float-right hidden-sm-down btn-success" data-toggle="modal" data-bs-toggle="modal" data-target="#Add_Hardware" data-bs-target="#Add_Hardware"><i class="mdi mdi-plus-circle"></i> Agregar</button>
                                                        ...
                                                        <tbody>
                                                            @foreach ($hardwares as $hardware)
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <button type="button" class="btn btn-primary" rel="tooltip" data-toggle="modal" data-bs-toggle="modal" data-target="#Edit_Hardware{{ $hardware->HAR_ID }}" data-bs-target="#Edit_Hardware{{ $hardware->HAR_ID }}">
...
$(document).ready(function() {
    console.log("Hardware modal script loaded");

    // Handler for add buttons (dynamic based on found patterns)
    
    $("[data-target=\"#Add_Hardware\"]").click(function(e) {
        e.preventDefault();
        console.log("Add button clicked for Add_Hardware");
        $("#Add_Hardware").show().addClass("show");
    ...
    $("[data-target^=\"#Edit_Hardware\"]").click(function(e) {
        e.preventDefault();
