...
@section('main')
                ...
                <div class="row page-titles">
                    ...
                    <div class="col-md-6 col-4 align-self-center">
                        <button class="btn float-right hidden-sm-down btn-success" data-toggle="modal" data-bs-toggle="modal" data-target="#Add_Tecnico" data-bs-target="#Add_Tecnico"><i class="mdi mdi-plus-circle"></i> Agregar</button>
                ...
                @include('Inventario.Tecnico.create')
@endsection
...
$(document).ready(function() {
    console.log("Tecnico modal script loaded");

    // Handler for add buttons (dynamic based on found patterns)
    
    $("[data-target=\"#Add_Tecnico\"]").click(function(e) {
        e.preventDefault();
        console.log("Add button clicked for Add_Tecnico");
        $("#Add_Tecnico").show().addClass("show");
