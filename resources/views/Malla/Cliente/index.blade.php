...
@section('main')
                ...
                <div class="row page-titles">
                    ...
                    <div class="col-md-6 col-4 align-self-center">
                        <button class="btn float-right hidden-sm-down btn-success" data-toggle="modal" data-bs-toggle="modal" data-target="#Add_Cliente" data-bs-target="#Add_Cliente"><i class="mdi mdi-plus-circle"></i> Agregar</button>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <button type="button" class="btn btn-primary" rel="tooltip" data-toggle="modal" data-bs-toggle="modal" data-target="#EditCliente{{ $list->CLI_ID }}" data-bs-target="#EditCliente{{ $list->CLI_ID }}">
...
$(document).ready(function() {
    console.log("Cliente modal script loaded");

    // Handler for add buttons (dynamic based on found patterns)
    
    $("[data-target=\"#Add_Cliente\"]").click(function(e) {
        e.preventDefault();
        console.log("Add button clicked for Add_Cliente");
        $("#Add_Cliente").show().addClass("show");
