                                            ...
                                            @foreach ($cargos as $list)
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <button type="button" class="btn btn-primary" rel="tooltip" data-toggle="modal" data-bs-toggle="modal" data-target="#EditCargo{{ $list->CAR_ID }}" data-bs-target="#EditCargo{{ $list->CAR_ID }}">
