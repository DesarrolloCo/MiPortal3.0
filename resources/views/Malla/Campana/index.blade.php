...
@section('main')
                ...
                <div class="row page-titles">
                    ...
                    <div class="col-md-6 col-4 align-self-center">
                        @can('crear-camp')
                        <button class="btn float-right hidden-sm-down btn-success" data-toggle="modal" data-bs-toggle="modal" data-target="#Add_Campana" data-bs-target="#Add_Campana"><i class="mdi mdi-plus-circle"></i> Agregar</button>
                        @endcan
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table class="table no-wrap display responsive nowrap" id="table_campana">
                                        <thead>
                                            <tr>
                                                <th>Uni - Ser</th>
                                                <th>Codigo</th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <button type="button" class="btn btn-primary" rel="tooltip" data-toggle="modal" data-bs-toggle="modal" data-target="#EditCampana{{ $list->CAM_ID }}" data-bs-target="#EditCampana{{ $list->CAM_ID }}">
...
$(document).ready(function() {
    console.log("Campana modal script loaded");

    // Handler for add buttons (dynamic based on found patterns)
    
    $("[data-target=\"#Add_Campana\"]").click(function(e) {
        e.preventDefault();
        console.log("Add button clicked for Add_Campana");
        $("#Add_Campana").show().addClass("show");
