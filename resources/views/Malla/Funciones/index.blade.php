...
@section('main')
                ...
                <div class="row page-titles">
                    ...
                    <div class="col-md-6 col-4 align-self-center">
                        <button class="btn float-right hidden-sm-down btn-success" data-toggle="modal" data-bs-toggle="modal" data-target="#Add_Funciones" data-bs-target="#Add_Funciones"><i class="mdi mdi-plus-circle"></i> Agregar</button>
                                            ...
                                            @foreach ($funciones as $list)
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <button class="btn float-right hidden-sm-down btn-primary" data-toggle="modal" data-bs-toggle="modal" data-target="#EditFuncion{{ $list->EMF_ID }}" data-bs-target="#EditFuncion{{ $list->EMF_ID }}"><i class="fas fa-edit"></i></button>
...
$(document).ready(function() {
    console.log("Funciones modal script loaded");

    // Handler for add buttons (dynamic based on found patterns)
    
    $("[data-target=\"#Add_Funciones\"]").click(function(e) {
        e.preventDefault();
        console.log("Add button clicked for Add_Funciones");
        $("#Add_Funciones").show().addClass("show");
