...
$(document).ready(function() {
    console.log("Jornada modal script loaded");

    // Handler for add buttons (dynamic based on found patterns)
    
    $("[data-target=\"#Add_Jornada\"]").click(function(e) {
        e.preventDefault();
        console.log("Add button clicked for Add_Jornada");
        $("#Add_Jornada").show().addClass("show");
