        ...
        <div class="col-lg-10 offset-lg-1">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Editar: {{ $evento->titulo }}</li>
                </ol>
            </nav>

            <div class="card">
                <div class="card-body">
                    <h4 class="card-title"><i class="mdi mdi-pencil"></i> Editar Evento</h4>
                    <h6 class="card-subtitle mb-4">Modifique los campos necesarios</h6>

                    <form action="{{ route('extranet.eventos.update', $evento->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('titulo') is-invalid @enderror"
                                           id="titulo" name="titulo" value="{{ old('titulo', $evento->titulo) }}" required maxlength="255">
                                    @error('titulo')
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('tipo') is-invalid @enderror" id="tipo" name="tipo" required>
                                        <option value="reunion" {{ old('tipo', $evento->tipo) == 'reunion' ? 'selected' : '' }}>Reunión</option>
                                        <option value="capacitacion" {{ old('tipo', $evento->tipo) == 'capacitacion' ? 'selected' : '' }}>Capacitación</option>
                                        <option value="celebracion" {{ old('tipo', $evento->tipo) == 'celebracion' ? 'selected' : '' }}>Celebración</option>
                                        <option value="conferencia" {{ old('tipo', $evento->tipo) == 'conferencia' ? 'selected' : '' }}>Conferencia</option>
                                        <option value="team_building" {{ old('tipo', $evento->tipo) == 'team_building' ? 'selected' : '' }}>Team Building</option>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control @error('fecha_inicio') is-invalid @enderror"
                                           id="fecha_inicio" name="fecha_inicio" value="{{ old('fecha_inicio', \Carbon\Carbon::parse($evento->fecha_inicio)->format('Y-m-d')) }}" required>
                                    @error('fecha_inicio')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="time" class="form-control @error('hora_inicio') is-invalid @enderror"
                                           id="hora_inicio" name="hora_inicio" value="{{ old('hora_inicio', $evento->hora_inicio) }}" required>
                                    @error('hora_inicio')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control @error('fecha_fin') is-invalid @enderror"
                                           id="fecha_fin" name="fecha_fin" value="{{ old('fecha_fin', $evento->fecha_fin ? \Carbon\Carbon::parse($evento->fecha_fin)->format('Y-m-d') : '') }}">
                                    @error('fecha_fin')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="time" class="form-control @error('hora_fin') is-invalid @enderror"
                                           id="hora_fin" name="hora_fin" value="{{ old('hora_fin', $evento->hora_fin) }}">
                                    @error('hora_fin')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control @error('descripcion') is-invalid @enderror"
                                              id="descripcion" name="descripcion" rows="4">{{ old('descripcion', $evento->descripcion) }}</textarea>
                                    @error('descripcion')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6" id="campo_lugar">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('lugar') is-invalid @enderror"
                                           id="lugar" name="lugar" value="{{ old('lugar', $evento->lugar) }}" maxlength="255">
                                    @error('lugar')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <!-- Link virtual -->
                            <div class="col-md-6" id="campo_link">
                                <div class="form-group">
                                    ...
                                    <input type="url" class="form-control @error('link_virtual') is-invalid @enderror"
                                           id="link_virtual" name="link_virtual" value="{{ old('link_virtual', $evento->link_virtual) }}" maxlength="500"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control @error('cupo_maximo') is-invalid @enderror"
                                           id="cupo_maximo" name="cupo_maximo" value="{{ old('cupo_maximo', $evento->cupo_maximo) }}" min="1">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="color" class="form-control @error('color') is-invalid @enderror"
                                           id="color" name="color" value="{{ old('color', $evento->color) }}">
                                    @error('color')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <div class="mb-2">
                                        <img src="{{ $evento->imagen_url }}" alt="Imagen actual" class="img-thumbnail" style="max-height: 150px;">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" id="requiere_confirmacion" name="requiere_confirmacion" value="1" {{ old('requiere_confirmacion', $evento->requiere_confirmacion) ? 'checked' : '' }}>
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <button type="submit" class="btn btn-primary">
                                <i class="mdi mdi-content-save"></i> Actualizar Evento
                            </button>
                        </div>
                    </form>
                </div>
