...
<div class="container-fluid">
    <div class="row">
        <div class="col-lg-10 offset-lg-1">
            ...
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title"><i class="mdi mdi-clipboard-text-plus"></i> Crear Nuevo Proyecto</h4>
                    <h6 class="card-subtitle mb-4">Complete los campos para crear un proyecto</h6>

                    <form action="{{ route('extranet.proyectos.store') }}" method="POST">
                        @csrf
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('nombre') is-invalid @enderror"
                                           id="nombre" name="nombre" value="{{ old('nombre') }}" required maxlength="255">
                                    @error('nombre')
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control @error('objetivo') is-invalid @enderror"
                                              id="objetivo" name="objetivo" rows="3">{{ old('objetivo') }}</textarea>
                                    @error('objetivo')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('responsable_id') is-invalid @enderror" id="responsable_id" name="responsable_id">
                                        ...
                                        <option value="{{ $emp->EMP_ID }}" {{ old('responsable_id') == $emp->EMP_ID ? 'selected' : '' }}>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('departamento_id') is-invalid @enderror" id="departamento_id" name="departamento_id">
                                        ...
                                        <option value="{{ $dep->DEP_ID }}" {{ old('departamento_id') == $dep->DEP_ID ? 'selected' : '' }}>
                                            {{ $dep->DEP_NOMBRE }}
                                        </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control @error('progreso') is-invalid @enderror"
                                           id="progreso" name="progreso" value="{{ old('progreso', 0) }}" min="0" max="100">
                                    <small class="form-text text-muted">Se actualizará automáticamente según tareas</small>
                                    @error('progreso')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" class="form-control @error('presupuesto') is-invalid @enderror"
                                               id="presupuesto" name="presupuesto" value="{{ old('presupuesto') }}" min="0" step="0.01">
                                    </div>
                                    @error('presupuesto')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control @error('horas_estimadas') is-invalid @enderror"
                                           id="horas_estimadas" name="horas_estimadas" value="{{ old('horas_estimadas') }}" min="0">
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <button type="submit" class="btn btn-primary">
                                <i class="mdi mdi-content-save"></i> Crear Proyecto
                            </button>
                        </div>
                    </form>
                </div>
